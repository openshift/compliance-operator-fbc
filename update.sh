...
# Old (tag-based) image:
NEW_BUNDLE="quay.io/redhat-user-workloads/ocp-isc-tenant/compliance-operator-bundle-release:release-1.10"
...
for OCP_V in "${OCP_VERSIONS[@]}"; do
  ...
  opm validate "catalog/v${OCP_V}/compliance-operator/" \
